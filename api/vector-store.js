export default async function handler(req, res) {
  ...
  const messages = [
    {
      role: "system",
      content: "You are MOOT AI, a rigorous moot court debate partner. Be concise, cite logic clearly, ask targeted follow-ups, and keep a professional, coach-like tone. Format arguments in bullet points with bold headings when helpful."
    },
